...
#| eval: false
library(here)
knitr::include_graphics(path = here("readings", "04-data-collection-html", "images", "selectorgadget-hover.png"), dpi = 144)
```

3.  Click on the movie name to select it. The element you selected will be highlighted in green. SelectorGadget guesses which css selector you want (`#main h2` in this case), and highlights all matches in yellow (see total count equal to 7 as indicated on on the "Clear" button).

```{r}
#| echo: false
#| eval: false
knitr::include_graphics(here::here("readings", "04-data-collection-html", 
                        "images", "selectorgadget-click.png"), dpi = 144)
```
...
#| eval: false
knitr::include_graphics(here::here("readings", "04-data-collection-html", 
                        "images", "selectorgadget-too-many.png"), dpi = 144)
```
...
#| eval: false
knitr::include_graphics(here::here("readings", "04-data-collection-html", 
                        "images", "selectorgadget-remove.png"), dpi = 144)
```
