...
![A screenshot of a dashboard created with `flexdashboard`](../../images/dashboards/example_dashboard.png)
...
![A screenshot of opening a new RMarkdown with a flexdashboard template](../../images/dashboards/NewRMarkdown.png)
...
- GitHub repository: <https://github.com/jhu-statprogramming-fall-2024/biostat777-project4-stephaniehicks>

#### Some example dashboards from previous years
