...
- Familiarize yourself with the basics of [functional programming](../../readings/03-functional-programming/index.qmd) and the `purrr` package 
- Familiarize yourself with the [`map()` function](https://adv-r.hadley.nz/functionals.html#map) along with [map variants](https://adv-r.hadley.nz/functionals.html#map-variants) in `purrr` 
- Check out this amazing [cheatsheet](https://raw.githubusercontent.com/rstudio/cheatsheets/main/purrr.pdf)!
:::
...
If you want a deeper dive, check out Hadley Wickham's chapter on [Functionals](https://adv-r.hadley.nz/functionals.html)
...
- Recognize the function `map2` and `pmap` allow having more than one list as input.
- Recognize the function `walk` and its alternatives `walk2`, `walk_*`, which do not provide any output.

:::

## Slides 

- [Lecture 03: Functional programming](https://docs.google.com/presentation/d/1DLN5yxHFIt7spLrHSw-gVFh0hjU128wV79ks2UDmy8I/edit?usp=sharing)
